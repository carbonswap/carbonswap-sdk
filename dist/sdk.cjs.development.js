...
var getFactoryAddress = function getFactoryAddress(chainId) {
  switch (chainId) {
    case exports.ChainId.VOLTA:
      return '0xD44463E5299dC807924Ff94B05aF53b3dF037301';

    case exports.ChainId.EWC:
...
var INIT_CODE_HASH = '0x930f72af52e9f7553fd568961dff48b9d73ba993c0ddc3f637f6af07a34e97bd'; //export const INIT_CODE_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f'
...
var Currency = /*#__PURE__*/function () {
  ...
  Currency.getNativeCurrency = function getNativeCurrency(chainId) {
    ...
    var ncurr = _getNativeCurrency(chainId);
  ...
  _proto.getSymbol = function getSymbol(chainId) {
    ...
    if ((this === null || this === void 0 ? void 0 : this.symbol) === ETHER.symbol || (this === null || this === void 0 ? void 0 : this.symbol) === EWT.symbol || (this === null || this === void 0 ? void 0 : this.symbol) === VT.symbol) {
  ...
  _proto.getName = function getName(chainId) {
    ...
    if ((this === null || this === void 0 ? void 0 : this.name) === ETHER.name || (this === null || this === void 0 ? void 0 : this.name) === EWT.name || (this === null || this === void 0 ? void 0 : this.name) === VT.name) {
...
Currency.ETHER = /*#__PURE__*/new Currency(exports.ChainId.MAINNET, 18, 'ETH', 'Ether');
Currency.EWT = /*#__PURE__*/new Currency(exports.ChainId.EWC, 18, 'EWT', 'Energy Web Token');
Currency.VT = /*#__PURE__*/new Currency(exports.ChainId.VOLTA, 18, 'VT', 'Volta Token');
Currency.BNB = /*#__PURE__*/new Currency(exports.ChainId.BSC, 18, 'BNB', 'Binance Coin');
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount["native"] = function native(chainId, amount) {
    return new CurrencyAmount(_getNativeCurrency(chainId), amount);
  };
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount["native"](this.quoteCurrency.chainId, _Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'CLP', 'Carbonswap LP Token');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(getFactoryAddress(tokenA.chainId), solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    var nativeCurrency = _getNativeCurrency(pairs[0].chainId);
    !(input instanceof Token && pairs[0].involvesToken(input) || input === nativeCurrency && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === nativeCurrency && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === _getNativeCurrency(chainId)) return new TokenAmount(WETH[chainId], currencyAmount.raw);
    invariant(false, 'CURRENCY')  ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === _getNativeCurrency(chainId)) return WETH[chainId];
    invariant(false, 'CURRENCY')  ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    var nativeCurrency = _getNativeCurrency(route.chainId);
    this.route = route;
    this.tradeType = tradeType;
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === nativeCurrency ? CurrencyAmount["native"](route.chainId, amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === nativeCurrency ? CurrencyAmount["native"](route.chainId, amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : CurrencyAmount["native"](this.route.chainId, slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : CurrencyAmount["native"](this.route.chainId, slippageAdjustedAmountIn);
    }
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var nativeCurrency = _getNativeCurrency(trade.route.chainId);
...
exports.getNativeCurrency = _getNativeCurrency;
